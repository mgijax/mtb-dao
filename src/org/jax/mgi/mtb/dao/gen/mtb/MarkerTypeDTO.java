...
public class MarkerTypeDTO extends TableDTO
// extends+ 
...

{
    ...
    private Long MarkerTypeKeyOriginal;
     ...
     * <ul>
     * <li>full name: MarkerType._MarkerType_key
     * <li>column size: 18
     ...
     */
    public Long getMarkerTypeKeyOriginal() {
        return MarkerTypeKeyOriginal; 
    }
    ...
    public void setMarkerTypeKey(Long newVal) {
        ...
        if(this.MarkerTypeKeyOriginal == null) {
            this.MarkerTypeKeyOriginal = newVal;
        }
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: MarkerType.create_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: MarkerType.create_date
     * <li>column size: 23
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: MarkerType.update_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: MarkerType.update_date
     * <li>column size: 23
     * <li>jdbc type returned by the driver: Types.TIMESTAMP
     * </ul>
     *
     ...
     */
    public void copy(MarkerTypeDTO bean) {
    ...
    public String toString() {
        StringBuffer ret = new StringBuffer();
            ret.append("\n[MarkerType] ");
            ret.append("\n - MarkerType._MarkerType_key = ").append((MarkerTypeKey_is_initialized ? ("[" + (MarkerTypeKey == null ? null : MarkerTypeKey.toString()) + "]") : "not initialized"));
            ret.append("\n - MarkerType.name = ").append((name_is_initialized ? ("[" + (name == null ? null : name) + "]") : "not initialized"));
            ret.append("\n - MarkerType.create_user = ").append((createUser_is_initialized ? ("[" + (createUser == null ? null : createUser) + "]") : "not initialized"));
            ret.append("\n - MarkerType.create_date = ").append((createDate_is_initialized ? ("[" + (createDate == null ? null : createDate.toString()) + "]") : "not initialized"));
            ret.append("\n - MarkerType.update_user = ").append((updateUser_is_initialized ? ("[" + (updateUser == null ? null : updateUser) + "]") : "not initialized"));
            ret.append("\n - MarkerType.update_date = ").append((updateDate_is_initialized ? ("[" + (updateDate == null ? null : updateDate.toString()) + "]") : "not initialized"));
        return ret.toString();
    }
    ...
    public String toXML() {
        StringBuffer ret = new StringBuffer();
        ret.append("<table name=\"MarkerType\">\n");
