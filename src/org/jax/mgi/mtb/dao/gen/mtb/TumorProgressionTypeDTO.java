...
public class TumorProgressionTypeDTO extends TableDTO
// extends+ 
...

{
    ...
    private Long TumorProgressionTypeKeyOriginal;
     ...
     * <ul>
     * <li>full name: TumorProgressionType._TumorProgressionType_key
     * <li>column size: 18
     ...
     */
    public Long getTumorProgressionTypeKeyOriginal() {
        return TumorProgressionTypeKeyOriginal; 
    }
    ...
    public void setTumorProgressionTypeKey(Long newVal) {
        ...
        if(this.TumorProgressionTypeKeyOriginal == null) {
            this.TumorProgressionTypeKeyOriginal = newVal;
        }
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorProgressionType.name
     * <li>column size: 50
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorProgressionType.description
     * <li>column size: 255
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorProgressionType.create_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorProgressionType.create_date
     * <li>column size: 23
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorProgressionType.update_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorProgressionType.update_date
     * <li>column size: 23
     * <li>jdbc type returned by the driver: Types.TIMESTAMP
     * </ul>
     *
     ...
     */
    public void copy(TumorProgressionTypeDTO bean) {
    ...
    public String toString() {
        StringBuffer ret = new StringBuffer();
            ret.append("\n[TumorProgressionType] ");
            ret.append("\n - TumorProgressionType._TumorProgressionType_key = ").append((TumorProgressionTypeKey_is_initialized ? ("[" + (TumorProgressionTypeKey == null ? null : TumorProgressionTypeKey.toString()) + "]") : "not initialized"));
            ret.append("\n - TumorProgressionType.name = ").append((name_is_initialized ? ("[" + (name == null ? null : name) + "]") : "not initialized"));
            ret.append("\n - TumorProgressionType.description = ").append((description_is_initialized ? ("[" + (description == null ? null : description) + "]") : "not initialized"));
            ret.append("\n - TumorProgressionType.create_user = ").append((createUser_is_initialized ? ("[" + (createUser == null ? null : createUser) + "]") : "not initialized"));
            ret.append("\n - TumorProgressionType.create_date = ").append((createDate_is_initialized ? ("[" + (createDate == null ? null : createDate.toString()) + "]") : "not initialized"));
            ret.append("\n - TumorProgressionType.update_user = ").append((updateUser_is_initialized ? ("[" + (updateUser == null ? null : updateUser) + "]") : "not initialized"));
            ret.append("\n - TumorProgressionType.update_date = ").append((updateDate_is_initialized ? ("[" + (updateDate == null ? null : updateDate.toString()) + "]") : "not initialized"));
        return ret.toString();
    }
    ...
    public String toXML() {
        StringBuffer ret = new StringBuffer();
        ret.append("<table name=\"TumorProgressionType\">\n");
