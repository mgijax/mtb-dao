...
public class AlleleMarkerAssocTypeDTO extends TableDTO
// extends+ 
...

{
     ...
     * <ul>
     * <li>full name: AlleleMarkerAssocType._AlleleMarkerAssocType_key
     * <li>column size: 18
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: AlleleMarkerAssocType.name
     * <li>column size: 50
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: AlleleMarkerAssocType.description
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: AlleleMarkerAssocType.create_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: AlleleMarkerAssocType.create_date
     * <li>column size: 23
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: AlleleMarkerAssocType.update_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: AlleleMarkerAssocType.update_date
     * <li>column size: 23
     * <li>jdbc type returned by the driver: Types.TIMESTAMP
     * </ul>
     *
     ...
     */
    public void copy(AlleleMarkerAssocTypeDTO bean) {
    ...
    public String toString() {
        StringBuffer ret = new StringBuffer();
            ret.append("\n[AlleleMarkerAssocType] ");
            ret.append("\n - AlleleMarkerAssocType._AlleleMarkerAssocType_key = ").append((AlleleMarkerAssocTypeKey_is_initialized ? ("[" + (AlleleMarkerAssocTypeKey == null ? null : AlleleMarkerAssocTypeKey.toString()) + "]") : "not initialized"));
            ret.append("\n - AlleleMarkerAssocType.name = ").append((name_is_initialized ? ("[" + (name == null ? null : name) + "]") : "not initialized"));
            ret.append("\n - AlleleMarkerAssocType.description = ").append((description_is_initialized ? ("[" + (description == null ? null : description) + "]") : "not initialized"));
            ret.append("\n - AlleleMarkerAssocType.create_user = ").append((createUser_is_initialized ? ("[" + (createUser == null ? null : createUser) + "]") : "not initialized"));
            ret.append("\n - AlleleMarkerAssocType.create_date = ").append((createDate_is_initialized ? ("[" + (createDate == null ? null : createDate.toString()) + "]") : "not initialized"));
            ret.append("\n - AlleleMarkerAssocType.update_user = ").append((updateUser_is_initialized ? ("[" + (updateUser == null ? null : updateUser) + "]") : "not initialized"));
            ret.append("\n - AlleleMarkerAssocType.update_date = ").append((updateDate_is_initialized ? ("[" + (updateDate == null ? null : updateDate.toString()) + "]") : "not initialized"));
        return ret.toString();
    }
    ...
    public String toXML() {
        StringBuffer ret = new StringBuffer();
        ret.append("<table name=\"AlleleMarkerAssocType\">\n");
