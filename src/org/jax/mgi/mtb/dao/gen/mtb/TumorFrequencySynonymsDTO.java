...
public class TumorFrequencySynonymsDTO extends TableDTO
// extends+ 
...

{
    ...
    private Long TumorFrequencySynonymsKeyOriginal;
    
    private Long TumorFrequencySynonymsKey;
    private boolean TumorFrequencySynonymsKey_is_modified = false;
    private boolean TumorFrequencySynonymsKey_is_initialized = false;
    ...
    /**
     * Getter method for TumorFrequencySynonymsKey.
     * <br>
     * PRIMARY KEY.<br>
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorFrequencySynonyms._TumorFrequencySynonyms_key
     * <li>column size: 18
     * <li>jdbc type returned by the driver: Types.NUMERIC
     * </ul>
     *
     * @return the value of TumorFrequencySynonymsKey
     */
    public Long getTumorFrequencySynonymsKeyOriginal() {
        return TumorFrequencySynonymsKeyOriginal; 
    }
     ...
     * @return the value of TumorFrequencySynonymsKey
     */
    public Long getTumorFrequencySynonymsKey() {
        return TumorFrequencySynonymsKey; 
    }

    /**
     * Setter method for TumorFrequencySynonymsKey.
     * <br>
     * The new value is set only if compareTo() says it is different,
     * or if one of either the new value or the current value is null.
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to TumorFrequencySynonymsKey
     */
    public void setTumorFrequencySynonymsKey(Long newVal) {
        if ((newVal != null && this.TumorFrequencySynonymsKey != null && (newVal.compareTo(this.TumorFrequencySynonymsKey) == 0)) || 
            (newVal == null && this.TumorFrequencySynonymsKey == null && TumorFrequencySynonymsKey_is_initialized)) {
            return; 
        } 

        if(this.TumorFrequencySynonymsKeyOriginal == null) {
            this.TumorFrequencySynonymsKeyOriginal = newVal;
        }
        this.TumorFrequencySynonymsKey = newVal; 

        TumorFrequencySynonymsKey_is_modified = true; 
        TumorFrequencySynonymsKey_is_initialized = true; 
    }
     ...
     */
    public void setTumorFrequencySynonymsKey(long newVal) {
        setTumorFrequencySynonymsKey(new Long(newVal));
    }

    /**
     * Determines if the TumorFrequencySynonymsKey has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isTumorFrequencySynonymsKeyModified() {
        return TumorFrequencySynonymsKey_is_modified; 
    }

    /**
     * Determines if the TumorFrequencySynonymsKey has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isTumorFrequencySynonymsKeyInitialized() {
        return TumorFrequencySynonymsKey_is_initialized; 
    }
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorFrequencySynonyms._TumorFrequency_key
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorFrequencySynonyms._Reference_key
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorFrequencySynonyms.name
     * <li>column size: 255
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorFrequencySynonyms.create_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorFrequencySynonyms.create_date
     * <li>column size: 23
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorFrequencySynonyms.update_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorFrequencySynonyms.update_date
     * <li>column size: 23
     * <li>jdbc type returned by the driver: Types.TIMESTAMP
     * </ul>
     *
    ...
    public void resetIsModified() {
        TumorFrequencySynonymsKey_is_modified = false;
     ...
     */
    public void copy(TumorFrequencySynonymsDTO bean) {
        setTumorFrequencySynonymsKey(bean.getTumorFrequencySynonymsKey());
    ...
    public String toString() {
        StringBuffer ret = new StringBuffer();
            ret.append("\n[TumorFrequencySynonyms] ");
            ret.append("\n - TumorFrequencySynonyms._TumorFrequencySynonyms_key = ").append((TumorFrequencySynonymsKey_is_initialized ? ("[" + (TumorFrequencySynonymsKey == null ? null : TumorFrequencySynonymsKey.toString()) + "]") : "not initialized"));
            ret.append("\n - TumorFrequencySynonyms._TumorFrequency_key = ").append((TumorFrequencyKey_is_initialized ? ("[" + (TumorFrequencyKey == null ? null : TumorFrequencyKey.toString()) + "]") : "not initialized"));
            ret.append("\n - TumorFrequencySynonyms._Reference_key = ").append((ReferenceKey_is_initialized ? ("[" + (ReferenceKey == null ? null : ReferenceKey.toString()) + "]") : "not initialized"));
            ret.append("\n - TumorFrequencySynonyms.name = ").append((name_is_initialized ? ("[" + (name == null ? null : name) + "]") : "not initialized"));
            ret.append("\n - TumorFrequencySynonyms.create_user = ").append((createUser_is_initialized ? ("[" + (createUser == null ? null : createUser) + "]") : "not initialized"));
            ret.append("\n - TumorFrequencySynonyms.create_date = ").append((createDate_is_initialized ? ("[" + (createDate == null ? null : createDate.toString()) + "]") : "not initialized"));
            ret.append("\n - TumorFrequencySynonyms.update_user = ").append((updateUser_is_initialized ? ("[" + (updateUser == null ? null : updateUser) + "]") : "not initialized"));
            ret.append("\n - TumorFrequencySynonyms.update_date = ").append((updateDate_is_initialized ? ("[" + (updateDate == null ? null : updateDate.toString()) + "]") : "not initialized"));
        return ret.toString();
    }
    ...
    public String toXML() {
        StringBuffer ret = new StringBuffer();
        ret.append("<table name=\"TumorFrequencySynonyms\">\n");
        ret.append("    <column name=\"_TumorFrequencySynonyms_key\"\n");
        ret.append("            value=\"").append((TumorFrequencySynonymsKey_is_initialized ? ((TumorFrequencySynonymsKey == null ? null : TumorFrequencySynonymsKey.toString())) : "[not initialized]")).append("\"/>\n");
