...
public class GenotypeDTO extends TableDTO
// extends+ 
...

{
    ...
    private Long GenotypeKeyOriginal;
    
    private Long GenotypeKey;
    private boolean GenotypeKey_is_modified = false;
    private boolean GenotypeKey_is_initialized = false;
    ...
    /**
     * Getter method for GenotypeKey.
     * <br>
     * PRIMARY KEY.<br>
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Genotype._Genotype_key
     * <li>column size: 18
     * <li>jdbc type returned by the driver: Types.NUMERIC
     * </ul>
     *
     * @return the value of GenotypeKey
     */
    public Long getGenotypeKeyOriginal() {
        return GenotypeKeyOriginal; 
    }
     ...
     * @return the value of GenotypeKey
     */
    public Long getGenotypeKey() {
        return GenotypeKey; 
    }

    /**
     * Setter method for GenotypeKey.
     * <br>
     * The new value is set only if compareTo() says it is different,
     * or if one of either the new value or the current value is null.
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to GenotypeKey
     */
    public void setGenotypeKey(Long newVal) {
        if ((newVal != null && this.GenotypeKey != null && (newVal.compareTo(this.GenotypeKey) == 0)) || 
            (newVal == null && this.GenotypeKey == null && GenotypeKey_is_initialized)) {
            return; 
        } 

        if(this.GenotypeKeyOriginal == null) {
            this.GenotypeKeyOriginal = newVal;
        }
        this.GenotypeKey = newVal; 

        GenotypeKey_is_modified = true; 
        GenotypeKey_is_initialized = true; 
    }
     ...
     */
    public void setGenotypeKey(long newVal) {
        setGenotypeKey(new Long(newVal));
    }

    /**
     * Determines if the GenotypeKey has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isGenotypeKeyModified() {
        return GenotypeKey_is_modified; 
    }

    /**
     * Determines if the GenotypeKey has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isGenotypeKeyInitialized() {
        return GenotypeKey_is_initialized; 
    }
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Genotype._Strain_key
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Genotype._AllelePair_key
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Genotype._Reference_key
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Genotype.create_user
     * <li>column size: 50
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Genotype.create_date
     * <li>column size: 23
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Genotype.update_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Genotype.update_date
     * <li>column size: 23
     * <li>jdbc type returned by the driver: Types.TIMESTAMP
     * </ul>
     *
     ...
     */
    public void copy(GenotypeDTO bean) {
        setGenotypeKey(bean.getGenotypeKey());
    ...
    public String toString() {
        StringBuffer ret = new StringBuffer();
            ret.append("\n[Genotype] ");
            ret.append("\n - Genotype._Genotype_key = ").append((GenotypeKey_is_initialized ? ("[" + (GenotypeKey == null ? null : GenotypeKey.toString()) + "]") : "not initialized"));
            ret.append("\n - Genotype._Strain_key = ").append((StrainKey_is_initialized ? ("[" + (StrainKey == null ? null : StrainKey.toString()) + "]") : "not initialized"));
            ret.append("\n - Genotype._AllelePair_key = ").append((AllelePairKey_is_initialized ? ("[" + (AllelePairKey == null ? null : AllelePairKey.toString()) + "]") : "not initialized"));
            ret.append("\n - Genotype._Reference_key = ").append((ReferenceKey_is_initialized ? ("[" + (ReferenceKey == null ? null : ReferenceKey.toString()) + "]") : "not initialized"));
            ret.append("\n - Genotype.create_user = ").append((createUser_is_initialized ? ("[" + (createUser == null ? null : createUser) + "]") : "not initialized"));
            ret.append("\n - Genotype.create_date = ").append((createDate_is_initialized ? ("[" + (createDate == null ? null : createDate.toString()) + "]") : "not initialized"));
            ret.append("\n - Genotype.update_user = ").append((updateUser_is_initialized ? ("[" + (updateUser == null ? null : updateUser) + "]") : "not initialized"));
            ret.append("\n - Genotype.update_date = ").append((updateDate_is_initialized ? ("[" + (updateDate == null ? null : updateDate.toString()) + "]") : "not initialized"));
        return ret.toString();
    }
    ...
    public String toXML() {
        StringBuffer ret = new StringBuffer();
        ret.append("<table name=\"Genotype\">\n");
        ret.append("    <column name=\"_Genotype_key\"\n");
        ret.append("            value=\"").append((GenotypeKey_is_initialized ? ((GenotypeKey == null ? null : GenotypeKey.toString())) : "[not initialized]")).append("\"/>\n");
