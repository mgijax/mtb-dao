...
public class MTBSecurityLevelDTO extends TableDTO
// extends+ 
...

{
    ...
    private Long MTBSecurityLevelKeyOriginal;
     ...
     * <ul>
     * <li>full name: MTBSecurityLevel._MTBSecurityLevel_key
     * <li>column size: 18
     ...
     */
    public Long getMTBSecurityLevelKeyOriginal() {
        return MTBSecurityLevelKeyOriginal; 
    }
    ...
    public void setMTBSecurityLevelKey(Long newVal) {
        ...
        if(this.MTBSecurityLevelKeyOriginal == null) {
            this.MTBSecurityLevelKeyOriginal = newVal;
        }
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: MTBSecurityLevel.description
     * <li>column size: 50
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: MTBSecurityLevel.create_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: MTBSecurityLevel.create_date
     * <li>column size: 23
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: MTBSecurityLevel.update_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: MTBSecurityLevel.update_date
     * <li>column size: 23
     * <li>jdbc type returned by the driver: Types.TIMESTAMP
     * </ul>
     *
     ...
     */
    public void copy(MTBSecurityLevelDTO bean) {
    ...
    public String toString() {
        StringBuffer ret = new StringBuffer();
            ret.append("\n[MTBSecurityLevel] ");
            ret.append("\n - MTBSecurityLevel._MTBSecurityLevel_key = ").append((MTBSecurityLevelKey_is_initialized ? ("[" + (MTBSecurityLevelKey == null ? null : MTBSecurityLevelKey.toString()) + "]") : "not initialized"));
            ret.append("\n - MTBSecurityLevel.description = ").append((description_is_initialized ? ("[" + (description == null ? null : description) + "]") : "not initialized"));
            ret.append("\n - MTBSecurityLevel.create_user = ").append((createUser_is_initialized ? ("[" + (createUser == null ? null : createUser) + "]") : "not initialized"));
            ret.append("\n - MTBSecurityLevel.create_date = ").append((createDate_is_initialized ? ("[" + (createDate == null ? null : createDate.toString()) + "]") : "not initialized"));
            ret.append("\n - MTBSecurityLevel.update_user = ").append((updateUser_is_initialized ? ("[" + (updateUser == null ? null : updateUser) + "]") : "not initialized"));
            ret.append("\n - MTBSecurityLevel.update_date = ").append((updateDate_is_initialized ? ("[" + (updateDate == null ? null : updateDate.toString()) + "]") : "not initialized"));
        return ret.toString();
    }
    ...
    public String toXML() {
        StringBuffer ret = new StringBuffer();
        ret.append("<table name=\"MTBSecurityLevel\">\n");
