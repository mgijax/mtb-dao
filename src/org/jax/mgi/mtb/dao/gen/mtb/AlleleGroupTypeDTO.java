...
public class AlleleGroupTypeDTO extends TableDTO
// extends+ 
...

{
    ...
    private Long AlleleGroupTypeKeyOriginal;
     ...
     * <ul>
     * <li>full name: AlleleGroupType._AlleleGroupType_key
     * <li>column size: 18
     ...
     */
    public Long getAlleleGroupTypeKeyOriginal() {
        return AlleleGroupTypeKeyOriginal; 
    }
    ...
    public void setAlleleGroupTypeKey(Long newVal) {
        ...
        if(this.AlleleGroupTypeKeyOriginal == null) {
            this.AlleleGroupTypeKeyOriginal = newVal;
        }
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: AlleleGroupType.name
     * <li>column size: 255
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: AlleleGroupType.description
     * <li>column size: 255
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: AlleleGroupType.create_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: AlleleGroupType.create_date
     * <li>column size: 23
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: AlleleGroupType.update_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: AlleleGroupType.update_date
     * <li>column size: 23
     * <li>jdbc type returned by the driver: Types.TIMESTAMP
     * </ul>
     *
     ...
     */
    public void copy(AlleleGroupTypeDTO bean) {
    ...
    public String toString() {
        StringBuffer ret = new StringBuffer();
            ret.append("\n[AlleleGroupType] ");
            ret.append("\n - AlleleGroupType._AlleleGroupType_key = ").append((AlleleGroupTypeKey_is_initialized ? ("[" + (AlleleGroupTypeKey == null ? null : AlleleGroupTypeKey.toString()) + "]") : "not initialized"));
            ret.append("\n - AlleleGroupType.name = ").append((name_is_initialized ? ("[" + (name == null ? null : name) + "]") : "not initialized"));
            ret.append("\n - AlleleGroupType.description = ").append((description_is_initialized ? ("[" + (description == null ? null : description) + "]") : "not initialized"));
            ret.append("\n - AlleleGroupType.create_user = ").append((createUser_is_initialized ? ("[" + (createUser == null ? null : createUser) + "]") : "not initialized"));
            ret.append("\n - AlleleGroupType.create_date = ").append((createDate_is_initialized ? ("[" + (createDate == null ? null : createDate.toString()) + "]") : "not initialized"));
            ret.append("\n - AlleleGroupType.update_user = ").append((updateUser_is_initialized ? ("[" + (updateUser == null ? null : updateUser) + "]") : "not initialized"));
            ret.append("\n - AlleleGroupType.update_date = ").append((updateDate_is_initialized ? ("[" + (updateDate == null ? null : updateDate.toString()) + "]") : "not initialized"));
        return ret.toString();
    }
    ...
    public String toXML() {
        StringBuffer ret = new StringBuffer();
        ret.append("<table name=\"AlleleGroupType\">\n");
