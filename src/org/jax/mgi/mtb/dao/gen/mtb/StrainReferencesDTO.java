...
public class StrainReferencesDTO extends TableDTO
// extends+ 
...

{
    ...
    private Long StrainReferencesKeyOriginal;
    
    private Long StrainReferencesKey;
    private boolean StrainReferencesKey_is_modified = false;
    private boolean StrainReferencesKey_is_initialized = false;
    ...
    /**
     * Getter method for StrainReferencesKey.
     * <br>
     * PRIMARY KEY.<br>
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: StrainReferences._StrainReferences_key
     * <li>column size: 18
     * <li>jdbc type returned by the driver: Types.NUMERIC
     * </ul>
     *
     * @return the value of StrainReferencesKey
     */
    public Long getStrainReferencesKeyOriginal() {
        return StrainReferencesKeyOriginal; 
    }
     ...
     * @return the value of StrainReferencesKey
     */
    public Long getStrainReferencesKey() {
        return StrainReferencesKey; 
    }

    /**
     * Setter method for StrainReferencesKey.
     * <br>
     * The new value is set only if compareTo() says it is different,
     * or if one of either the new value or the current value is null.
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to StrainReferencesKey
     */
    public void setStrainReferencesKey(Long newVal) {
        if ((newVal != null && this.StrainReferencesKey != null && (newVal.compareTo(this.StrainReferencesKey) == 0)) || 
            (newVal == null && this.StrainReferencesKey == null && StrainReferencesKey_is_initialized)) {
            return; 
        } 

        if(this.StrainReferencesKeyOriginal == null) {
            this.StrainReferencesKeyOriginal = newVal;
        }
        this.StrainReferencesKey = newVal; 

        StrainReferencesKey_is_modified = true; 
        StrainReferencesKey_is_initialized = true; 
    }
     ...
     */
    public void setStrainReferencesKey(long newVal) {
        setStrainReferencesKey(new Long(newVal));
    }

    /**
     * Determines if the StrainReferencesKey has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isStrainReferencesKeyModified() {
        return StrainReferencesKey_is_modified; 
    }

    /**
     * Determines if the StrainReferencesKey has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isStrainReferencesKeyInitialized() {
        return StrainReferencesKey_is_initialized; 
    }
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: StrainReferences._Strain_key
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: StrainReferences._Reference_key
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: StrainReferences.create_user
     * <li>column size: 50
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: StrainReferences.create_date
     * <li>column size: 23
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: StrainReferences.update_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: StrainReferences.update_date
     * <li>column size: 23
     * <li>jdbc type returned by the driver: Types.TIMESTAMP
     * </ul>
     *
    ...
    public void resetIsModified() {
        StrainReferencesKey_is_modified = false;
     ...
     */
    public void copy(StrainReferencesDTO bean) {
        setStrainReferencesKey(bean.getStrainReferencesKey());
    ...
    public String toString() {
        StringBuffer ret = new StringBuffer();
            ret.append("\n[StrainReferences] ");
            ret.append("\n - StrainReferences._StrainReferences_key = ").append((StrainReferencesKey_is_initialized ? ("[" + (StrainReferencesKey == null ? null : StrainReferencesKey.toString()) + "]") : "not initialized"));
            ret.append("\n - StrainReferences._Strain_key = ").append((StrainKey_is_initialized ? ("[" + (StrainKey == null ? null : StrainKey.toString()) + "]") : "not initialized"));
            ret.append("\n - StrainReferences._Reference_key = ").append((ReferenceKey_is_initialized ? ("[" + (ReferenceKey == null ? null : ReferenceKey.toString()) + "]") : "not initialized"));
            ret.append("\n - StrainReferences.create_user = ").append((createUser_is_initialized ? ("[" + (createUser == null ? null : createUser) + "]") : "not initialized"));
            ret.append("\n - StrainReferences.create_date = ").append((createDate_is_initialized ? ("[" + (createDate == null ? null : createDate.toString()) + "]") : "not initialized"));
            ret.append("\n - StrainReferences.update_user = ").append((updateUser_is_initialized ? ("[" + (updateUser == null ? null : updateUser) + "]") : "not initialized"));
            ret.append("\n - StrainReferences.update_date = ").append((updateDate_is_initialized ? ("[" + (updateDate == null ? null : updateDate.toString()) + "]") : "not initialized"));
        return ret.toString();
    }
    ...
    public String toXML() {
        StringBuffer ret = new StringBuffer();
        ret.append("<table name=\"StrainReferences\">\n");
        ret.append("    <column name=\"_StrainReferences_key\"\n");
        ret.append("            value=\"").append((StrainReferencesKey_is_initialized ? ((StrainReferencesKey == null ? null : StrainReferencesKey.toString())) : "[not initialized]")).append("\"/>\n");
