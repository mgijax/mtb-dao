...
public class AgentTypeDTO extends TableDTO
// extends+ 
...

{
    ...
    private Long AgentTypeKeyOriginal;
    
    private Long AgentTypeKey;
    private boolean AgentTypeKey_is_modified = false;
    private boolean AgentTypeKey_is_initialized = false;
    ...
    /**
     * Getter method for AgentTypeKey.
     * <br>
     * PRIMARY KEY.<br>
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: AgentType._AgentType_key
     * <li>column size: 18
     * <li>jdbc type returned by the driver: Types.NUMERIC
     * </ul>
     *
     * @return the value of AgentTypeKey
     */
    public Long getAgentTypeKeyOriginal() {
        return AgentTypeKeyOriginal; 
    }
    ...
    /**
     * Setter method for AgentTypeKey.
     * <br>
     * The new value is set only if compareTo() says it is different,
     * or if one of either the new value or the current value is null.
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to AgentTypeKey
     */
    public void setAgentTypeKey(Long newVal) {
        if ((newVal != null && this.AgentTypeKey != null && (newVal.compareTo(this.AgentTypeKey) == 0)) || 
            (newVal == null && this.AgentTypeKey == null && AgentTypeKey_is_initialized)) {
            return; 
        } 

        if(this.AgentTypeKeyOriginal == null) {
            this.AgentTypeKeyOriginal = newVal;
        }
        this.AgentTypeKey = newVal; 

        AgentTypeKey_is_modified = true; 
        AgentTypeKey_is_initialized = true; 
    }
     ...
     */
    public void setAgentTypeKey(long newVal) {
        setAgentTypeKey(new Long(newVal));
    }

    /**
     * Determines if the AgentTypeKey has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isAgentTypeKeyModified() {
        return AgentTypeKey_is_modified; 
    }

    /**
     * Determines if the AgentTypeKey has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isAgentTypeKeyInitialized() {
        return AgentTypeKey_is_initialized; 
    }
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: AgentType.description
     * <li>column size: 255
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: AgentType.create_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: AgentType.create_date
     * <li>column size: 23
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: AgentType.update_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: AgentType.update_date
     * <li>column size: 23
     * <li>jdbc type returned by the driver: Types.TIMESTAMP
     * </ul>
     *
    ...
    public void resetIsModified() {
        AgentTypeKey_is_modified = false;
     ...
     */
    public void copy(AgentTypeDTO bean) {
        setAgentTypeKey(bean.getAgentTypeKey());
    ...
    public String toString() {
        StringBuffer ret = new StringBuffer();
            ret.append("\n[AgentType] ");
            ret.append("\n - AgentType._AgentType_key = ").append((AgentTypeKey_is_initialized ? ("[" + (AgentTypeKey == null ? null : AgentTypeKey.toString()) + "]") : "not initialized"));
            ret.append("\n - AgentType.name = ").append((name_is_initialized ? ("[" + (name == null ? null : name) + "]") : "not initialized"));
            ret.append("\n - AgentType.description = ").append((description_is_initialized ? ("[" + (description == null ? null : description) + "]") : "not initialized"));
            ret.append("\n - AgentType.create_user = ").append((createUser_is_initialized ? ("[" + (createUser == null ? null : createUser) + "]") : "not initialized"));
            ret.append("\n - AgentType.create_date = ").append((createDate_is_initialized ? ("[" + (createDate == null ? null : createDate.toString()) + "]") : "not initialized"));
            ret.append("\n - AgentType.update_user = ").append((updateUser_is_initialized ? ("[" + (updateUser == null ? null : updateUser) + "]") : "not initialized"));
            ret.append("\n - AgentType.update_date = ").append((updateDate_is_initialized ? ("[" + (updateDate == null ? null : updateDate.toString()) + "]") : "not initialized"));
        return ret.toString();
    }
    ...
    public String toXML() {
        StringBuffer ret = new StringBuffer();
        ret.append("<table name=\"AgentType\">\n");
        ret.append("    <column name=\"_AgentType_key\"\n");
        ret.append("            value=\"").append((AgentTypeKey_is_initialized ? ((AgentTypeKey == null ? null : AgentTypeKey.toString())) : "[not initialized]")).append("\"/>\n");
