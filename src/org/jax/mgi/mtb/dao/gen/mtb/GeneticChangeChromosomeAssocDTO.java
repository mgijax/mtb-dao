...
public class GeneticChangeChromosomeAssocDTO extends TableDTO
// extends+ 
...

{
     ...
     */
    GeneticChangeChromosomeAssocDTO() {
        // EMPTY CONSTRUCTOR
    }
     ...
     * <ul>
     * <li>full name: GeneticChangeChromosomeAssoc._TumorGeneticChanges_key
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: GeneticChangeChromosomeAssoc._Chromosome_key
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: GeneticChangeChromosomeAssoc.create_user
     * <li>column size: 12
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: GeneticChangeChromosomeAssoc.create_date
     * <li>column size: 23
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: GeneticChangeChromosomeAssoc.update_user
     * <li>column size: 12
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: GeneticChangeChromosomeAssoc.update_date
     * <li>column size: 23
     * <li>jdbc type returned by the driver: Types.TIMESTAMP
     * </ul>
     *
     ...
     */
    public void copy(GeneticChangeChromosomeAssocDTO bean) {
    ...
    public String toString() {
        StringBuffer ret = new StringBuffer();
            ret.append("\n[GeneticChangeChromosomeAssoc] ");
            ret.append("\n - GeneticChangeChromosomeAssoc._TumorGeneticChanges_key = ").append((TumorGeneticChangesKey_is_initialized ? ("[" + (TumorGeneticChangesKey == null ? null : TumorGeneticChangesKey.toString()) + "]") : "not initialized"));
            ret.append("\n - GeneticChangeChromosomeAssoc._Chromosome_key = ").append((ChromosomeKey_is_initialized ? ("[" + (ChromosomeKey == null ? null : ChromosomeKey.toString()) + "]") : "not initialized"));
            ret.append("\n - GeneticChangeChromosomeAssoc.create_user = ").append((createUser_is_initialized ? ("[" + (createUser == null ? null : createUser) + "]") : "not initialized"));
            ret.append("\n - GeneticChangeChromosomeAssoc.create_date = ").append((createDate_is_initialized ? ("[" + (createDate == null ? null : createDate.toString()) + "]") : "not initialized"));
            ret.append("\n - GeneticChangeChromosomeAssoc.update_user = ").append((updateUser_is_initialized ? ("[" + (updateUser == null ? null : updateUser) + "]") : "not initialized"));
            ret.append("\n - GeneticChangeChromosomeAssoc.update_date = ").append((updateDate_is_initialized ? ("[" + (updateDate == null ? null : updateDate.toString()) + "]") : "not initialized"));
        return ret.toString();
    }
    ...
    public String toXML() {
        StringBuffer ret = new StringBuffer();
        ret.append("<table name=\"GeneticChangeChromosomeAssoc\">\n");
