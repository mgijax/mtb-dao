...
public class TumorClassificationDTO extends TableDTO
// extends+ 
...

{
    ...
    private Long TumorClassificationKeyOriginal;
    ...
    private Long TCParentKey;
    private boolean TCParentKey_is_modified = false;
    private boolean TCParentKey_is_initialized = false;
     ...
     * <ul>
     * <li>full name: TumorClassification._TumorClassification_key
     * <li>column size: 18
     ...
     */
    public Long getTumorClassificationKeyOriginal() {
        return TumorClassificationKeyOriginal; 
    }
    ...
    public void setTumorClassificationKey(Long newVal) {
        ...
        if(this.TumorClassificationKeyOriginal == null) {
            this.TumorClassificationKeyOriginal = newVal;
        }
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorClassification.name
     * <li>column size: 250
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorClassification.create_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorClassification.create_date
     * <li>column size: 23
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorClassification.update_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorClassification.update_date
     * <li>column size: 23
     * <li>jdbc type returned by the driver: Types.TIMESTAMP
     * </ul>
     *
    ...
    /**
     * Getter method for TCParentKey.
     * <br>
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorClassification._TCParent_key
     * <li> foreign key: TumorClassification._TumorClassification_key
     * <li>column size: 18
     * <li>jdbc type returned by the driver: Types.NUMERIC
     * </ul>
     *
     * @return the value of TCParentKey
     */
    public Long getTCParentKey() {
        return TCParentKey; 
    }

    /**
     * Setter method for TCParentKey.
     * <br>
     * The new value is set only if compareTo() says it is different,
     * or if one of either the new value or the current value is null.
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to TCParentKey
     */
    public void setTCParentKey(Long newVal) {
        if ((newVal != null && this.TCParentKey != null && (newVal.compareTo(this.TCParentKey) == 0)) || 
            (newVal == null && this.TCParentKey == null && TCParentKey_is_initialized)) {
            return; 
        } 
        this.TCParentKey = newVal; 

        TCParentKey_is_modified = true; 
        TCParentKey_is_initialized = true; 
    }
     ...
     */
    public void setTCParentKey(long newVal) {
        setTCParentKey(new Long(newVal));
    }

    /**
     * Determines if the TCParentKey has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isTCParentKeyModified() {
        return TCParentKey_is_modified; 
    }

    /**
     * Determines if the TCParentKey has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isTCParentKeyInitialized() {
        return TCParentKey_is_initialized; 
    }
     ...
     */
    public void copy(TumorClassificationDTO bean) {
        ...
        setTCParentKey(bean.getTCParentKey());
    }
    ...
    public String toString() {
        StringBuffer ret = new StringBuffer();
            ret.append("\n[TumorClassification] ");
            ret.append("\n - TumorClassification._TumorClassification_key = ").append((TumorClassificationKey_is_initialized ? ("[" + (TumorClassificationKey == null ? null : TumorClassificationKey.toString()) + "]") : "not initialized"));
            ret.append("\n - TumorClassification.name = ").append((name_is_initialized ? ("[" + (name == null ? null : name) + "]") : "not initialized"));
            ret.append("\n - TumorClassification.create_user = ").append((createUser_is_initialized ? ("[" + (createUser == null ? null : createUser) + "]") : "not initialized"));
            ret.append("\n - TumorClassification.create_date = ").append((createDate_is_initialized ? ("[" + (createDate == null ? null : createDate.toString()) + "]") : "not initialized"));
            ret.append("\n - TumorClassification.update_user = ").append((updateUser_is_initialized ? ("[" + (updateUser == null ? null : updateUser) + "]") : "not initialized"));
            ret.append("\n - TumorClassification.update_date = ").append((updateDate_is_initialized ? ("[" + (updateDate == null ? null : updateDate.toString()) + "]") : "not initialized"));
            ret.append("\n - TumorClassification._TCParent_key = ").append((TCParentKey_is_initialized ? ("[" + (TCParentKey == null ? null : TCParentKey.toString()) + "]") : "not initialized"));
        return ret.toString();
    }
    ...
    public String toXML() {
        StringBuffer ret = new StringBuffer();
        ret.append("<table name=\"TumorClassification\">\n");
        ...
        ret.append("    <column name=\"_TCParent_key\"\n");
        ret.append("            value=\"").append((TCParentKey_is_initialized ? ((TCParentKey == null ? null : TCParentKey.toString())) : "[not initialized]")).append("\"/>\n");
        ret.append("</table>");
        return ret.toString();
    }
