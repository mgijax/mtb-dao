...
public class AlleleDTO extends TableDTO
// extends+ 
...

{
    ...
    private Long somaticInd;
    private boolean somaticInd_is_modified = false;
    private boolean somaticInd_is_initialized = false;
    
    private Long CellLineKey;
    private boolean CellLineKey_is_modified = false;
    private boolean CellLineKey_is_initialized = false;
     ...
     * <ul>
     * <li>full name: Allele._Allele_key
     * <li>column size: 18
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Allele._AlleleType_key
    ...
    /**
     * Getter method for somaticInd.
     * <br>
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Allele.somaticInd
     * <li>column size: 18
     * <li>jdbc type returned by the driver: Types.NUMERIC
     * </ul>
     *
     * @return the value of somaticInd
     */
    public Long getSomaticInd() {
        return somaticInd; 
    }

    /**
     * Setter method for somaticInd.
     * <br>
     * The new value is set only if compareTo() says it is different,
     * or if one of either the new value or the current value is null.
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to somaticInd
     */
    public void setSomaticInd(Long newVal) {
        if ((newVal != null && this.somaticInd != null && (newVal.compareTo(this.somaticInd) == 0)) || 
            (newVal == null && this.somaticInd == null && somaticInd_is_initialized)) {
            return; 
        } 
        this.somaticInd = newVal; 

        somaticInd_is_modified = true; 
        somaticInd_is_initialized = true; 
    }
     ...
     */
    public void setSomaticInd(long newVal) {
        setSomaticInd(new Long(newVal));
    }

    /**
     * Determines if the somaticInd has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isSomaticIndModified() {
        return somaticInd_is_modified; 
    }

    /**
     * Determines if the somaticInd has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isSomaticIndInitialized() {
        return somaticInd_is_initialized; 
    }

    /**
     * Getter method for CellLineKey.
     * <br>
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Allele._CellLine_key
     * <li> foreign key: CellLine._CellLine_key
     * <li>column size: 18
     * <li>jdbc type returned by the driver: Types.NUMERIC
     * </ul>
     *
     * @return the value of CellLineKey
     */
    public Long getCellLineKey() {
        return CellLineKey; 
    }

    /**
     * Setter method for CellLineKey.
     * <br>
     * The new value is set only if compareTo() says it is different,
     * or if one of either the new value or the current value is null.
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to CellLineKey
     */
    public void setCellLineKey(Long newVal) {
        if ((newVal != null && this.CellLineKey != null && (newVal.compareTo(this.CellLineKey) == 0)) || 
            (newVal == null && this.CellLineKey == null && CellLineKey_is_initialized)) {
            return; 
        } 
        this.CellLineKey = newVal; 

        CellLineKey_is_modified = true; 
        CellLineKey_is_initialized = true; 
    }
     ...
     */
    public void setCellLineKey(long newVal) {
        setCellLineKey(new Long(newVal));
    }

    /**
     * Determines if the CellLineKey has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isCellLineKeyModified() {
        return CellLineKey_is_modified; 
    }

    /**
     * Determines if the CellLineKey has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isCellLineKeyInitialized() {
        return CellLineKey_is_initialized; 
    }
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Allele.create_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Allele.create_date
     * <li>column size: 23
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Allele.update_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Allele.update_date
     * <li>column size: 23
     * <li>jdbc type returned by the driver: Types.TIMESTAMP
     * </ul>
     *
    ...
    public boolean isModified() {
     ...
     name_is_modified || 
     symbol_is_modified || 
     somaticInd_is_modified || 
     CellLineKey_is_modified || 
     note_is_modified || 
    ...
    public void resetIsModified() {
        ...
        somaticInd_is_modified = false;
        CellLineKey_is_modified = false;
     ...
     */
    public void copy(AlleleDTO bean) {
        setAlleleKey(bean.getAlleleKey());
        setAlleleTypeKey(bean.getAlleleTypeKey());
        setName(bean.getName());
        setSymbol(bean.getSymbol());
        setSomaticInd(bean.getSomaticInd());
        setCellLineKey(bean.getCellLineKey());
    ...
    public String toString() {
        StringBuffer ret = new StringBuffer();
            ret.append("\n[Allele] ");
            ret.append("\n - Allele._Allele_key = ").append((AlleleKey_is_initialized ? ("[" + (AlleleKey == null ? null : AlleleKey.toString()) + "]") : "not initialized"));
            ret.append("\n - Allele._AlleleType_key = ").append((AlleleTypeKey_is_initialized ? ("[" + (AlleleTypeKey == null ? null : AlleleTypeKey.toString()) + "]") : "not initialized"));
            ret.append("\n - Allele.name = ").append((name_is_initialized ? ("[" + (name == null ? null : name) + "]") : "not initialized"));
            ret.append("\n - Allele.symbol = ").append((symbol_is_initialized ? ("[" + (symbol == null ? null : symbol) + "]") : "not initialized"));
            ret.append("\n - Allele.somaticInd = ").append((somaticInd_is_initialized ? ("[" + (somaticInd == null ? null : somaticInd.toString()) + "]") : "not initialized"));
            ret.append("\n - Allele._CellLine_key = ").append((CellLineKey_is_initialized ? ("[" + (CellLineKey == null ? null : CellLineKey.toString()) + "]") : "not initialized"));
            ret.append("\n - Allele.note = ").append((note_is_initialized ? ("[" + (note == null ? null : note) + "]") : "not initialized"));
            ret.append("\n - Allele.create_user = ").append((createUser_is_initialized ? ("[" + (createUser == null ? null : createUser) + "]") : "not initialized"));
            ret.append("\n - Allele.create_date = ").append((createDate_is_initialized ? ("[" + (createDate == null ? null : createDate.toString()) + "]") : "not initialized"));
            ret.append("\n - Allele.update_user = ").append((updateUser_is_initialized ? ("[" + (updateUser == null ? null : updateUser) + "]") : "not initialized"));
            ret.append("\n - Allele.update_date = ").append((updateDate_is_initialized ? ("[" + (updateDate == null ? null : updateDate.toString()) + "]") : "not initialized"));
        return ret.toString();
    }
    ...
    public String toXML() {
        ...
        ret.append("    <column name=\"somaticInd\"\n");
        ret.append("            value=\"").append((somaticInd_is_initialized ? ((somaticInd == null ? null : somaticInd.toString())) : "[not initialized]")).append("\"/>\n");
        ret.append("    <column name=\"_CellLine_key\"\n");
        ret.append("            value=\"").append((CellLineKey_is_initialized ? ((CellLineKey == null ? null : CellLineKey.toString())) : "[not initialized]")).append("\"/>\n");
