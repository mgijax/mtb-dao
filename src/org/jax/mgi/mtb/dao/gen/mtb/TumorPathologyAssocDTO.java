...
public class TumorPathologyAssocDTO extends TableDTO
// extends+ 
...

{
     ...
     * <ul>
     * <li>full name: TumorPathologyAssoc._Pathology_key
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorPathologyAssoc._TumorFrequency_key
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorPathologyAssoc.create_user
     * <li>column size: 50
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorPathologyAssoc.create_date
     * <li>column size: 23
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorPathologyAssoc.update_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorPathologyAssoc.update_date
     * <li>column size: 23
     * <li>jdbc type returned by the driver: Types.TIMESTAMP
     * </ul>
     *
     ...
     */
    public void copy(TumorPathologyAssocDTO bean) {
    ...
    public String toString() {
        StringBuffer ret = new StringBuffer();
            ret.append("\n[TumorPathologyAssoc] ");
            ret.append("\n - TumorPathologyAssoc._Pathology_key = ").append((PathologyKey_is_initialized ? ("[" + (PathologyKey == null ? null : PathologyKey.toString()) + "]") : "not initialized"));
            ret.append("\n - TumorPathologyAssoc._TumorFrequency_key = ").append((TumorFrequencyKey_is_initialized ? ("[" + (TumorFrequencyKey == null ? null : TumorFrequencyKey.toString()) + "]") : "not initialized"));
            ret.append("\n - TumorPathologyAssoc.create_user = ").append((createUser_is_initialized ? ("[" + (createUser == null ? null : createUser) + "]") : "not initialized"));
            ret.append("\n - TumorPathologyAssoc.create_date = ").append((createDate_is_initialized ? ("[" + (createDate == null ? null : createDate.toString()) + "]") : "not initialized"));
            ret.append("\n - TumorPathologyAssoc.update_user = ").append((updateUser_is_initialized ? ("[" + (updateUser == null ? null : updateUser) + "]") : "not initialized"));
            ret.append("\n - TumorPathologyAssoc.update_date = ").append((updateDate_is_initialized ? ("[" + (updateDate == null ? null : updateDate.toString()) + "]") : "not initialized"));
        return ret.toString();
    }
    ...
    public String toXML() {
        StringBuffer ret = new StringBuffer();
        ret.append("<table name=\"TumorPathologyAssoc\">\n");
