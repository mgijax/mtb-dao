...
public class StrainHeredityDTO extends TableDTO
// extends+ 
...

{
     ...
     * <ul>
     * <li>full name: StrainHeredity._StrainHeredity_key
     * <li>column size: 18
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: StrainHeredity.name
     * <li>column size: 255
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: StrainHeredity.description
     * <li>column size: 255
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: StrainHeredity.create_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: StrainHeredity.create_date
     * <li>column size: 23
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: StrainHeredity.update_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: StrainHeredity.update_date
     * <li>column size: 23
     * <li>jdbc type returned by the driver: Types.TIMESTAMP
     * </ul>
     *
     ...
     */
    public void copy(StrainHeredityDTO bean) {
    ...
    public String toString() {
        StringBuffer ret = new StringBuffer();
            ret.append("\n[StrainHeredity] ");
            ret.append("\n - StrainHeredity._StrainHeredity_key = ").append((StrainHeredityKey_is_initialized ? ("[" + (StrainHeredityKey == null ? null : StrainHeredityKey.toString()) + "]") : "not initialized"));
            ret.append("\n - StrainHeredity.name = ").append((name_is_initialized ? ("[" + (name == null ? null : name) + "]") : "not initialized"));
            ret.append("\n - StrainHeredity.description = ").append((description_is_initialized ? ("[" + (description == null ? null : description) + "]") : "not initialized"));
            ret.append("\n - StrainHeredity.create_user = ").append((createUser_is_initialized ? ("[" + (createUser == null ? null : createUser) + "]") : "not initialized"));
            ret.append("\n - StrainHeredity.create_date = ").append((createDate_is_initialized ? ("[" + (createDate == null ? null : createDate.toString()) + "]") : "not initialized"));
            ret.append("\n - StrainHeredity.update_user = ").append((updateUser_is_initialized ? ("[" + (updateUser == null ? null : updateUser) + "]") : "not initialized"));
            ret.append("\n - StrainHeredity.update_date = ").append((updateDate_is_initialized ? ("[" + (updateDate == null ? null : updateDate.toString()) + "]") : "not initialized"));
        return ret.toString();
    }
    ...
    public String toXML() {
        StringBuffer ret = new StringBuffer();
        ret.append("<table name=\"StrainHeredity\">\n");
