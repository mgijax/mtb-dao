...
public class StrainFamilyDTO extends TableDTO
// extends+ 
...

{
    ...
    private boolean family_is_modified = false;
    private boolean family_is_initialized = false;
     ...
     * <ul>
     * <li>full name: StrainFamily._StrainFamily_key
     * <li>column size: 18
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: StrainFamily.family
     * <li>column size: 50
     ...
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to family
     */
    public void setFamily(String newVal) {
        if ((newVal != null && this.family != null && (newVal.compareTo(this.family) == 0)) || 
            (newVal == null && this.family == null && family_is_initialized)) {
            return; 
        } 
        this.family = newVal; 

        family_is_modified = true; 
        family_is_initialized = true; 
    }
    ...
    public boolean isFamilyModified() {
        return family_is_modified; 
    }

    /**
     * Determines if the family has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: StrainFamily.create_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: StrainFamily.create_date
     * <li>column size: 23
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: StrainFamily.update_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: StrainFamily.update_date
     * <li>column size: 23
     * <li>jdbc type returned by the driver: Types.TIMESTAMP
     * </ul>
     *
     ...
     */
    public void copy(StrainFamilyDTO bean) {
    ...
    public String toString() {
        StringBuffer ret = new StringBuffer();
            ret.append("\n[StrainFamily] ");
            ret.append("\n - StrainFamily._StrainFamily_key = ").append((StrainFamilyKey_is_initialized ? ("[" + (StrainFamilyKey == null ? null : StrainFamilyKey.toString()) + "]") : "not initialized"));
            ret.append("\n - StrainFamily.family = ").append((family_is_initialized ? ("[" + (family == null ? null : family) + "]") : "not initialized"));
            ret.append("\n - StrainFamily.create_user = ").append((createUser_is_initialized ? ("[" + (createUser == null ? null : createUser) + "]") : "not initialized"));
            ret.append("\n - StrainFamily.create_date = ").append((createDate_is_initialized ? ("[" + (createDate == null ? null : createDate.toString()) + "]") : "not initialized"));
            ret.append("\n - StrainFamily.update_user = ").append((updateUser_is_initialized ? ("[" + (updateUser == null ? null : updateUser) + "]") : "not initialized"));
            ret.append("\n - StrainFamily.update_date = ").append((updateDate_is_initialized ? ("[" + (updateDate == null ? null : updateDate.toString()) + "]") : "not initialized"));
        return ret.toString();
    }
    ...
    public String toXML() {
        StringBuffer ret = new StringBuffer();
        ret.append("<table name=\"StrainFamily\">\n");
        ...
        ret.append("    <column name=\"family\"\n");
        ret.append("            value=\"").append((family_is_initialized ? ((family == null ? null : family)) : "[not initialized]")).append("\"/>\n");
