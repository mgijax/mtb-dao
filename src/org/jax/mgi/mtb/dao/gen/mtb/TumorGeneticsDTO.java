...
public class TumorGeneticsDTO extends TableDTO
// extends+ 
...

{
    ...
    private Long TumorGeneticsKeyOriginal;
    
    private Long TumorGeneticsKey;
    private boolean TumorGeneticsKey_is_modified = false;
    private boolean TumorGeneticsKey_is_initialized = false;
    ...
    /**
     * Getter method for TumorGeneticsKey.
     * <br>
     * PRIMARY KEY.<br>
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorGenetics._TumorGenetics_key
     * <li>column size: 18
     * <li>jdbc type returned by the driver: Types.NUMERIC
     * </ul>
     *
     * @return the value of TumorGeneticsKey
     */
    public Long getTumorGeneticsKeyOriginal() {
        return TumorGeneticsKeyOriginal; 
    }
     ...
     * @return the value of TumorGeneticsKey
     */
    public Long getTumorGeneticsKey() {
        return TumorGeneticsKey; 
    }

    /**
     * Setter method for TumorGeneticsKey.
     * <br>
     * The new value is set only if compareTo() says it is different,
     * or if one of either the new value or the current value is null.
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to TumorGeneticsKey
     */
    public void setTumorGeneticsKey(Long newVal) {
        if ((newVal != null && this.TumorGeneticsKey != null && (newVal.compareTo(this.TumorGeneticsKey) == 0)) || 
            (newVal == null && this.TumorGeneticsKey == null && TumorGeneticsKey_is_initialized)) {
            return; 
        } 

        if(this.TumorGeneticsKeyOriginal == null) {
            this.TumorGeneticsKeyOriginal = newVal;
        }
        this.TumorGeneticsKey = newVal; 

        TumorGeneticsKey_is_modified = true; 
        TumorGeneticsKey_is_initialized = true; 
    }
     ...
     */
    public void setTumorGeneticsKey(long newVal) {
        setTumorGeneticsKey(new Long(newVal));
    }

    /**
     * Determines if the TumorGeneticsKey has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isTumorGeneticsKeyModified() {
        return TumorGeneticsKey_is_modified; 
    }

    /**
     * Determines if the TumorGeneticsKey has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isTumorGeneticsKeyInitialized() {
        return TumorGeneticsKey_is_initialized; 
    }
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorGenetics._TumorFrequency_key
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorGenetics._AllelePair_key
     * <li> foreign key: AllelePair._AllelePair_key
     * <li>column size: 18
     * <li>jdbc type returned by the driver: Types.NUMERIC
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorGenetics.notes
     * <li>column size: 255
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorGenetics.create_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorGenetics.create_date
     * <li>column size: 23
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorGenetics.update_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: TumorGenetics.update_date
     * <li>column size: 23
     * <li>jdbc type returned by the driver: Types.TIMESTAMP
     * </ul>
     *
    ...
    public void resetIsModified() {
        TumorGeneticsKey_is_modified = false;
     ...
     */
    public void copy(TumorGeneticsDTO bean) {
        setTumorGeneticsKey(bean.getTumorGeneticsKey());
    ...
    public String toString() {
        StringBuffer ret = new StringBuffer();
            ret.append("\n[TumorGenetics] ");
            ret.append("\n - TumorGenetics._TumorGenetics_key = ").append((TumorGeneticsKey_is_initialized ? ("[" + (TumorGeneticsKey == null ? null : TumorGeneticsKey.toString()) + "]") : "not initialized"));
            ret.append("\n - TumorGenetics._TumorFrequency_key = ").append((TumorFrequencyKey_is_initialized ? ("[" + (TumorFrequencyKey == null ? null : TumorFrequencyKey.toString()) + "]") : "not initialized"));
            ret.append("\n - TumorGenetics._AllelePair_key = ").append((AllelePairKey_is_initialized ? ("[" + (AllelePairKey == null ? null : AllelePairKey.toString()) + "]") : "not initialized"));
            ret.append("\n - TumorGenetics.notes = ").append((notes_is_initialized ? ("[" + (notes == null ? null : notes) + "]") : "not initialized"));
            ret.append("\n - TumorGenetics.create_user = ").append((createUser_is_initialized ? ("[" + (createUser == null ? null : createUser) + "]") : "not initialized"));
            ret.append("\n - TumorGenetics.create_date = ").append((createDate_is_initialized ? ("[" + (createDate == null ? null : createDate.toString()) + "]") : "not initialized"));
            ret.append("\n - TumorGenetics.update_user = ").append((updateUser_is_initialized ? ("[" + (updateUser == null ? null : updateUser) + "]") : "not initialized"));
            ret.append("\n - TumorGenetics.update_date = ").append((updateDate_is_initialized ? ("[" + (updateDate == null ? null : updateDate.toString()) + "]") : "not initialized"));
        return ret.toString();
    }
    ...
    public String toXML() {
        StringBuffer ret = new StringBuffer();
        ret.append("<table name=\"TumorGenetics\">\n");
        ret.append("    <column name=\"_TumorGenetics_key\"\n");
        ret.append("            value=\"").append((TumorGeneticsKey_is_initialized ? ((TumorGeneticsKey == null ? null : TumorGeneticsKey.toString())) : "[not initialized]")).append("\"/>\n");
