...
public class OrganismDTO extends TableDTO
// extends+ 
...

{
    ...
    private Long OrganismKeyOriginal;
    ...
    private boolean latinName_is_modified = false;
    private boolean latinName_is_initialized = false;
     ...
     * <ul>
     * <li>full name: Organism._Organism_key
     * <li>column size: 18
     ...
     */
    public Long getOrganismKeyOriginal() {
        return OrganismKeyOriginal; 
    }
    ...
    public void setOrganismKey(Long newVal) {
        ...
        if(this.OrganismKeyOriginal == null) {
            this.OrganismKeyOriginal = newVal;
        }
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Organism.commonName
     * <li>column size: 255
    ...
    /**
     * Getter method for latinName.
     * <br>
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Organism.latinName
     * <li>column size: 255
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
    ...
    /**
     * Setter method for latinName.
     * <br>
     * The new value is set only if compareTo() says it is different,
     * or if one of either the new value or the current value is null.
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to latinName
     */
    public void setLatinName(String newVal) {
        if ((newVal != null && this.latinName != null && (newVal.compareTo(this.latinName) == 0)) || 
            (newVal == null && this.latinName == null && latinName_is_initialized)) {
            return; 
        } 
        this.latinName = newVal; 

        latinName_is_modified = true; 
        latinName_is_initialized = true; 
    }

    /**
     * Determines if the latinName has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isLatinNameModified() {
        return latinName_is_modified; 
    }

    /**
     * Determines if the latinName has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isLatinNameInitialized() {
        return latinName_is_initialized; 
    }
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Organism.create_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Organism.create_date
     * <li>column size: 23
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Organism.update_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Organism.update_date
     * <li>column size: 23
     * <li>jdbc type returned by the driver: Types.TIMESTAMP
     * </ul>
     *
    ...
    public String toString() {
        StringBuffer ret = new StringBuffer();
            ret.append("\n[Organism] ");
            ret.append("\n - Organism._Organism_key = ").append((OrganismKey_is_initialized ? ("[" + (OrganismKey == null ? null : OrganismKey.toString()) + "]") : "not initialized"));
            ret.append("\n - Organism.commonName = ").append((commonName_is_initialized ? ("[" + (commonName == null ? null : commonName) + "]") : "not initialized"));
            ret.append("\n - Organism.latinName = ").append((latinName_is_initialized ? ("[" + (latinName == null ? null : latinName) + "]") : "not initialized"));
            ret.append("\n - Organism.create_user = ").append((createUser_is_initialized ? ("[" + (createUser == null ? null : createUser) + "]") : "not initialized"));
            ret.append("\n - Organism.create_date = ").append((createDate_is_initialized ? ("[" + (createDate == null ? null : createDate.toString()) + "]") : "not initialized"));
            ret.append("\n - Organism.update_user = ").append((updateUser_is_initialized ? ("[" + (updateUser == null ? null : updateUser) + "]") : "not initialized"));
            ret.append("\n - Organism.update_date = ").append((updateDate_is_initialized ? ("[" + (updateDate == null ? null : updateDate.toString()) + "]") : "not initialized"));
        return ret.toString();
    }
    ...
    public String toXML() {
        StringBuffer ret = new StringBuffer();
        ret.append("<table name=\"Organism\">\n");
        ...
        ret.append("    <column name=\"latinName\"\n");
        ret.append("            value=\"").append((latinName_is_initialized ? ((latinName == null ? null : latinName)) : "[not initialized]")).append("\"/>\n");
