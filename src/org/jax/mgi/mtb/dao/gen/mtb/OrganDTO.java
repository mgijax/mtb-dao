...
public class OrganDTO extends TableDTO
// extends+ 
...

{
    ...
    private Long OrganParentKey;
    private boolean OrganParentKey_is_modified = false;
    private boolean OrganParentKey_is_initialized = false;
     ...
     */
    public Long getOrganKeyOriginal() {
        return OrganKeyOriginal; 
    }
    ...
    public void setOrganKey(Long newVal) {
        ...
        if(this.OrganKeyOriginal == null) {
            this.OrganKeyOriginal = newVal;
        }
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Organ._AnatomicalSystem_key
     * <li> foreign key: AnatomicalSystem._AnatomicalSystem_key
     * <li>column size: 18
     * <li>jdbc type returned by the driver: Types.NUMERIC
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Organ.description
     * <li>column size: 255
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Organ.create_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Organ.create_date
     * <li>column size: 23
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Organ.update_user
     * <li>column size: 50
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Organ.update_date
     * <li>column size: 23
     * <li>jdbc type returned by the driver: Types.TIMESTAMP
     * </ul>
     *
    ...
    /**
     * Getter method for OrganParentKey.
     * <br>
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: Organ._OrganParent_key
     * <li> foreign key: Organ._Organ_key
     * <li>column size: 18
     * <li>jdbc type returned by the driver: Types.NUMERIC
     * </ul>
     *
     * @return the value of OrganParentKey
     */
    public Long getOrganParentKey() {
        return OrganParentKey; 
    }

    /**
     * Setter method for OrganParentKey.
     * <br>
     * The new value is set only if compareTo() says it is different,
     * or if one of either the new value or the current value is null.
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to OrganParentKey
     */
    public void setOrganParentKey(Long newVal) {
        if ((newVal != null && this.OrganParentKey != null && (newVal.compareTo(this.OrganParentKey) == 0)) || 
            (newVal == null && this.OrganParentKey == null && OrganParentKey_is_initialized)) {
            return; 
        } 
        this.OrganParentKey = newVal; 

        OrganParentKey_is_modified = true; 
        OrganParentKey_is_initialized = true; 
    }
     ...
     */
    public void setOrganParentKey(long newVal) {
        setOrganParentKey(new Long(newVal));
    }

    /**
     * Determines if the OrganParentKey has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isOrganParentKeyModified() {
        return OrganParentKey_is_modified; 
    }

    /**
     * Determines if the OrganParentKey has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isOrganParentKeyInitialized() {
        return OrganParentKey_is_initialized; 
    }
    ...
    public boolean isModified() {
        return OrganKey_is_modified || 
     AnatomicalSystemKey_is_modified || 
     name_is_modified || 
    ...
    public void resetIsModified() {
        ...
        OrganParentKey_is_modified = false;
    }
     ...
     */
    public void copy(OrganDTO bean) {
        ...
        setOrganParentKey(bean.getOrganParentKey());
    }
    ...
    public String toString() {
        StringBuffer ret = new StringBuffer();
            ret.append("\n[Organ] ");
            ret.append("\n - Organ._Organ_key = ").append((OrganKey_is_initialized ? ("[" + (OrganKey == null ? null : OrganKey.toString()) + "]") : "not initialized"));
            ret.append("\n - Organ._AnatomicalSystem_key = ").append((AnatomicalSystemKey_is_initialized ? ("[" + (AnatomicalSystemKey == null ? null : AnatomicalSystemKey.toString()) + "]") : "not initialized"));
            ret.append("\n - Organ.name = ").append((name_is_initialized ? ("[" + (name == null ? null : name) + "]") : "not initialized"));
            ret.append("\n - Organ.description = ").append((description_is_initialized ? ("[" + (description == null ? null : description) + "]") : "not initialized"));
            ret.append("\n - Organ.create_user = ").append((createUser_is_initialized ? ("[" + (createUser == null ? null : createUser) + "]") : "not initialized"));
            ret.append("\n - Organ.create_date = ").append((createDate_is_initialized ? ("[" + (createDate == null ? null : createDate.toString()) + "]") : "not initialized"));
            ret.append("\n - Organ.update_user = ").append((updateUser_is_initialized ? ("[" + (updateUser == null ? null : updateUser) + "]") : "not initialized"));
            ret.append("\n - Organ.update_date = ").append((updateDate_is_initialized ? ("[" + (updateDate == null ? null : updateDate.toString()) + "]") : "not initialized"));
            ret.append("\n - Organ._OrganParent_key = ").append((OrganParentKey_is_initialized ? ("[" + (OrganParentKey == null ? null : OrganParentKey.toString()) + "]") : "not initialized"));
        return ret.toString();
    }
    ...
    public String toXML() {
        ...
        ret.append("    <column name=\"_OrganParent_key\"\n");
        ret.append("            value=\"").append((OrganParentKey_is_initialized ? ((OrganParentKey == null ? null : OrganParentKey.toString())) : "[not initialized]")).append("\"/>\n");
        ret.append("</table>");
        return ret.toString();
    }
